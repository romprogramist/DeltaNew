...
public partial class DeltaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.Property(e => e.Address).HasDefaultValueSql("''::text");
            entity.Property(e => e.ImgBg).HasDefaultValueSql("''::text");
        });
        ...
        modelBuilder.Entity<Reagent>(entity =>
        {
            ...
            entity.Property(e => e.InstructionPdf).HasDefaultValueSql("''::text");
